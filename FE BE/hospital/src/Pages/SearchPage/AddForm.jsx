...
import { baseUrl, urls } from '../../router/axios_api';
...
const AddForm = ({ openAdd, setOpenAdd }) => {
  ...
  const handleSubmit = async(value) => {
    value =value[0]
    // value.date_of_birth = new Date(value.date_of_birth).getTime()
    // console.log("valuasb",value);
    await baseUrl.post(urls.createPatient,value)
  }
  return (
    <>
      <Modal
      ...
      >
        <Box sx={style}>
          ...
          <Divider />
          {/* Add form */}
          <form id="addForm"  onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', flex: '1' }}>
            ...
            <Box display={'flex'} justifyContent={'end'}>
              <Button type='submit' width={20} >Create</Button>
            </Box>
          </form>
        </Box>
      </Modal>

...
import TableContentInReport from "./TableContentInReport";
        ...
        <Stack mb={5} direction="column" spacing={10}>
          ...
          <Container>
            <Stack mb={5} direction="column" spacing={15}>
              <Stack direction="row" spacing={2} justifyContent="space-between">
                <Typography variant="h3">In Patient's Record</Typography>
              </Stack>
            </Stack>

            <TableContentInReport />
          </Container>
          {/* ----------------------------------------------------------------------- */}
          <Container>
            <Stack mb={5} direction="column" spacing={15}>
              <Stack direction="row" spacing={2} justifyContent="space-between">
                <Typography variant="h3">Record ID 123's patient</Typography>
              </Stack>
            </Stack>
          ...
          <Container>
            <Stack mb={5} direction="column" spacing={15}>
              <Stack direction="row" spacing={2} justifyContent="space-between">
                <Typography variant="h3">Record ID 333's Examines</Typography>
              </Stack>
            </Stack>
